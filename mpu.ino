...
void loop() {
  ...
  Serial.print("Tilt Angle X: "); Serial.print(angleX_deg); Serial.println("°");
  Serial.print("Tilt Angle Y: "); Serial.print(angleY_deg); Serial.println("°");
  Serial.print("Tilt Angle Z: "); Serial.print(angleZ_deg); Serial.println("°");
